	...
	<nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top topback" style="opacity:0.8">
		...
		<div class="navbar-collapse collapse w-100 order-3 dual-collapse2">
			<ul class="navbar-nav ml-auto">
				...
				<li class="nav-item">
					<a class="nav-link" href="https://twitter.com/McLuckServer"><i class="fab fa-twitter"></i>&nbsp;Twitter</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="https://stats.lucknetwork.jp"><i class="fas fa-check"></i>&nbsp;サーバー情報</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="https://rankings.lucknetwork.jp"><i class="fas fa-trophy"></i>&nbsp;ランキング</a>
				</li>
				<li class="nav-item">
					<a class="nav-link" href="https://punish.lucknetwork.jp"><i class="fas fa-ban"></i>&nbsp;処罰情報</a>
				</li>
				<li class="nav-item">
...
arsort($RSS);
	...
	?>
			...
			<div class="col-8">
				...
				<div class="col-4">
					...
					<div class="card border-primary mb-3" style="max-width: 100%;margin-top: 5px">
						<div class="card-header" style="text-align:center"><i class="fab fa-twitter"></i>&nbsp;Twitter</div>
						<div class="card-body"><a class="twitter-timeline" data-lang="ja" data-theme="light" data-link-color="#19CF86" href="https://twitter.com/McLuckServer?ref_src=twsrc%5Etfw">Tweets by McLuckServer</a> <script async src="https://platform.twitter.com/widgets.js" charset="utf-8"></script></div>
					</div>
		...
		<footer class="footer">
			...
			Minecraft は <a href="https://mojang.com">Mojang AB</a> の登録商標です。私達は、Mojang AB と何の商業的な関係もありません。
		</address>
			<div class="share">
			 <div class="facebook">
